...
export default function MenProducts() {
  ...
  // Filter States - Defaulted to Men's Clothing
  const [selectedCategories, setSelectedCategories] = useState<string[]>(['clothing']);
  const [selectedGenders, setSelectedGenders] = useState<string[]>(['men']);
    ...
    <div className="space-y-8">
      <div>
        <div className="flex items-center justify-between mb-4">
          <h3 className="font-bold text-sm uppercase tracking-widest text-ink">Men's Filters</h3>
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      <SEO
        ...
        description="Explore our premium men's fashion collection. From sophisticated suits to casual wear, discover high-quality clothing for the modern man."
        keywords="men's fashion, men's clothing, premium suits, casual wear for men, Premiura men"
      />
      <div className="mb-12">
        <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold tracking-tighter uppercase italic text-ink">Men's Collection</h1>
        <p className="text-muted mt-4 max-w-2xl">Discover our premium range of men's clothing, designed for style and comfort.</p>
      </div>
