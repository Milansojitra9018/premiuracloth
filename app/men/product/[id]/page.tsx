  ...
  if (!product) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-24 text-center">
        ...
        <button onClick={() => navigate.push('/men')} className="text-black underline">Back to Men's Collection</button>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      <SEO 
        ...
        keywords={`men's fashion, ${product.category}, ${product.name}, Premiura`}
        ...
        <div className="flex flex-col">
          <div className="mb-8">
            <div className="flex items-center space-x-2 mb-4">
              <span className="text-xs font-bold uppercase tracking-widest text-muted">Men's</span>
