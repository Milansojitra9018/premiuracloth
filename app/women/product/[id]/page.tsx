  ...
  if (!product) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-24 text-center">
        ...
        <button onClick={() => navigate.push('/women')} className="text-black underline">Back to Women's Collection</button>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      <SEO 
        ...
        keywords={`women's fashion, ${product.category}, ${product.name}, Premiura`}
        ...
        <div className="flex flex-col">
          <div className="mb-8">
            <div className="flex items-center space-x-2 mb-4">
              <span className="text-xs font-bold uppercase tracking-widest text-muted">Women's</span>
            ...
            <p className="text-3xl font-bold tracking-tight text-success">{formatCurrency(getProductPrice(product))}</p>
          </div>
