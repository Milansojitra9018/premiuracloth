...
export default function KidsProducts() {
  ...
  // Filter States - Defaulted to Kids' Clothing
    ...
    <div className="space-y-8">
      <div>
        <div className="flex items-center justify-between mb-4">
          <h3 className="font-bold text-sm uppercase tracking-widest text-ink">Kids' Filters</h3>
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      <SEO
        ...
        description="Shop our fun and durable kids' clothing collection. From playwear to special occasions, find high-quality fashion for children."
        keywords="kids' fashion, children's clothing, durable kids' wear, Premiura kids"
      />
      <div className="mb-12">
        <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold tracking-tighter uppercase italic text-ink">Kids' Collection</h1>
        <p className="text-muted mt-4 max-w-2xl">Fun, comfortable, and durable clothing for kids of all ages.</p>
      </div>
